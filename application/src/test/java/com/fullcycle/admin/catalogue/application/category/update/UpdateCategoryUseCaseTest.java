...
import com.fullcycle.admin.catalogue.application.category.create.CreateCategoryCommand;
...
public class UpdateCategoryUseCaseTest {
    ...
    @Test
    public void givenACommandWithInvalidIdCategory_whenCallsUpdateCategory_shouldReturnNotFoundException() {
        final var aCategory = Category.newCategory("Film", null, true);
