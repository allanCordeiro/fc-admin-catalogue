package com.fullcycle.admin.catalogue.application.retrieve.list;

import com.fullcycle.admin.catalogue.application.category.retrieve.list.CategoryListOutput;
import com.fullcycle.admin.catalogue.application.category.retrieve.list.DefaultListCategoriesUseCase;
...
public class ListCategoriesUseCaseTest {
    ...
    @Test
    public void givenAValidQuery_whenCallsListCategory_thenShouldReturnCategories() {
